...
class DQN:
    def __init__(self, D, K, hodden_layer_sizes, gamma, max_experiences=10000, min_experiences=100, batch_sz=32):
        self.K = K
    ...
    def train(self, target_network):
        ...
        states = [self.experince['s'][i] for i in idx]
    ...
    def play_one(env, model, tmodel, eps, gamma, copy_period):
        ...
        while not done and iters < 2000:
            ...
            model.add_experince(prev_observation, action, reward, observation, done)
            model.train(tmodel)
